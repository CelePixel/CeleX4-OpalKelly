    ...
    , m_uiValue(value)
{
    ...
    m_pLabelName->setStyleSheet("background: transparent; color: rgb(0, 0, 0); font: 16px Calibri");
    m_pLabelName->setAlignment(Qt::AlignRight|Qt::AlignVCenter);

    m_pLabelMin = new QLabel(QString::number(min), this);
    m_pLabelMin->setStyleSheet("background: transparent; color: black; font: 16px Calibri;");
    ...
    m_pLabelMax->setStyleSheet("background: transparent; color: black; font: 16px Calibri");

    m_pLabelValue = new QLabel(QString::number(value), this);
    m_pLabelValue->setAlignment(Qt::AlignCenter);
    m_pLabelValue->setStyleSheet("background: transparent; color: rgb(185, 15, 43); font: 16px Calibri");
